...
@section('title', 'Tin tức - Quán Nhậu Anh Em')
@section('meta_description', 'Nơi cập nhật nhanh nhất những sự kiện nóng hổi, chương trình khuyến mại, khách hàng và thông tin thương hiệu Quán Nhậu Anh Em.')
@section('meta_keywords', 'Tin tức quán nhậu anh em')
    ...
    <div class="news-banner-custom">
        <div class="news-banner-inner">
            ...
            <div class="news-banner-right">
                ...
                <img src="{{ BASE_URL }}images/Untitled-3.webp" alt="Mascot" class="news-mascot" loading="eager">
            </div>
        </div>
    </div>
