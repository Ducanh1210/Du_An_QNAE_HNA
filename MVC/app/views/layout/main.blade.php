...
<head>
    ...
    <style>
        :root {
            ...
            --accent: #d79627;
            --accent-hover: #f0ab2e;
            --accent-glow: rgba(215, 150, 39, 0.15);
            --text-primary: #f0f0f5;
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar-brand-icon {
            ...
            height: 40px;
            border-radius: 10px;
            background: linear-gradient(135deg, var(--accent), #b37a1a);
            display: flex;
            align-items: center;
        ...
        .stat-icon.products { background: rgba(215, 150, 39, 0.15); color: var(--accent); }
        .stat-icon.news { background: rgba(59, 130, 246, 0.15); color: var(--info); }
        .stat-icon.categories { background: rgba(34, 197, 94, 0.15); color: var(--success); }
        ...
        .btn-sm-action:hover { border-color: var(--accent); color: var(--accent); background: transparent; }
        .btn-sm-action.danger:hover { border-color: var(--danger); color: var(--danger); }
        ...
        .badge-product { background: rgba(215, 150, 39, 0.15); color: var(--accent); }
        .badge-news { background: rgba(59, 130, 246, 0.15); color: var(--info); }
...
<body>
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ BASE_URL }}categories" class="sidebar-link {{ str_contains(request_uri(), 'categor') ? 'active' : '' }}">
