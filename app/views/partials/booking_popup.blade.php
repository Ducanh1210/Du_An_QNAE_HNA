                                    ...
                                    <div class="number-order">
                                        <div class="minus">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M17 11.5H7C6.447 11.5 6 11.947 6 12.5C6 13.053 6.447 13.5 7 13.5H17C17.553 13.5 18 13.053 18 12.5C18 11.947 17.553 11.5 17 11.5Z" fill="#666666" />
                                            </svg>
                                        </div>
                                        <input type="number" class="txtQuantity" id="txtTotalCus" value="1" onkeypress="return /[0-9]/i.test(event.key)" />
                                        <div class="plus">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M17 11.5H13V7.5C13 6.947 12.553 6.5 12 6.5C11.447 6.5 11 6.947 11 7.5V11.5H7C6.447 11.5 6 11.947 6 12.5C6 13.053 6.447 13.5 7 13.5H11V17.5C11 18.053 11.447 18.5 12 18.5C12.553 18.5 13 18.053 13 17.5V13.5H17C17.553 13.5 18 13.053 18 12.5C18 11.947 17.553 11.5 17 11.5Z" fill="#666666" />
                                            </svg>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-type">
                                    ...
                                    <div class="dateBox" id="DateCome">
                                        ...
                                        <div class="icn icon-time-calendar">
                                            <img src="{{ BASE_URL }}images/calendar-icon.webp" class="ico-calendar" loading="eager" />
                                        </div>
                                    </div>
                                </div>
