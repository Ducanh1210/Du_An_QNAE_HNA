...
@section('meta_keywords', 'Quán Nhậu Anh Em, Quán nhậu Ninh Bình, quán nhậu Hà Nam, quán nhậu Lam Hạ, quán nhậu Phủ Lý, quán nhậu gần đây, quán nhậu ngon, Quán nhậu view đẹp Ninh Bình, Quán nhậu chill Ninh Bình, quán nhậu nổi tiếng')
...
@section('styles')
    ...
    <style>
        ...
        body.loading-active .premium-header-wrapper {
            padding-right: var(--scrollbar-compensate, 0px) !important;
        }
        ...
        .loading-screen .loading-bg {
            position: absolute;
            inset: 0;
            background: #faf6ee url('{{ BASE_URL }}images/bg-pattern.webp') center/cover no-repeat;
            z-index: 0;
        }
...
@section('schema')
    <script type="application/ld+json" class="rank-math-schema">
        {"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"#organization","name":"Quán Nhậu Anh Em","logo":{"@type":"ImageObject","@id":"#logo","url":"{{ BASE_URL }}images/Logo_PNG22_square.webp","contentUrl":"{{ BASE_URL }}images/Logo_PNG22_square.webp","caption":"Quán Nhậu Anh Em","inLanguage":"vi","width":"2000","height":"1995"}},{"@type":"WebSite","@id":"#website","url":"{{ BASE_URL }}","name":"Quán Nhậu Anh Em","publisher":{"@id":"#organization"},"inLanguage":"vi","potentialAction":{"@type":"SearchAction","target":"?s={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"ImageObject","@id":"{{ BASE_URL }}images/Thumb-Facebook.jpg","url":"{{ BASE_URL }}images/Thumb-Facebook.jpg","width":"2560","height":"1707","caption":"quán nhậu ninh bình - hệ thống quán nhậu anh em","inLanguage":"vi"},{"@type":"WebPage","@id":"#webpage","url":"","name":"Quán Nhậu Anh Em - Đặt Bàn Ngay Giảm Giá 10%","datePublished":"2018-02-06T11:00:42+07:00","dateModified":"2023-05-17T13:49:05+07:00","about":{"@id":"#organization"},"isPartOf":{"@id":"#website"},"primaryImageOfPage":{"@id":"{{ BASE_URL }}images/Thumb-Facebook.jpg"},"inLanguage":"vi"},{"@type":"Person","@id":"author/admin/","name":"admin","url":"author/admin/","image":{"@type":"ImageObject","@id":"https://secure.gravatar.com/avatar/dfaf919e7f8c631d101492cc7b9427b5?s=96&amp;d=mm&amp;r=g","url":"https://secure.gravatar.com/avatar/dfaf919e7f8c631d101492cc7b9427b5?s=96&amp;d=mm&amp;r=g","caption":"admin","inLanguage":"vi"},"worksFor":{"@id":"#organization"}},{"@type":"Article","headline":"Quán Nhậu Anh Em - Đặt Bàn Ngay Giảm Giá 10%","keywords":"quán nhậu anh em","datePublished":"2018-02-06T11:00:42+07:00","dateModified":"2023-05-17T13:49:05+07:00","author":{"@id":"author/admin/"},"publisher":{"@id":"#organization"},"description":"Quán Nhậu Anh Em - Ăn Nhậu Khỏi Lo, hệ thống nhà hàng quán nhậu số 1 Ninh Bình chuyên tổ chức Họp Mặt, Sinh Nhật, Tất Niên,... chỉ từ 199k/người với nhiều Ưu Đãi","name":"Quán Nhậu Anh Em - Đặt Bàn Ngay Giảm Giá 10%","@id":"#richSnippet","isPartOf":{"@id":"#webpage"},"image":{"@id":"{{ BASE_URL }}images/Thumb-Facebook.jpg"},"inLanguage":"vi","mainEntityOfPage":{"@id":"#webpage"}}]}
    </script>

    <!-- ld+json breadcrumb 5 main page-->
    <script type="application/ld+json">
        {
    ...
    <div class="td-content__wrapper td-home__wrapper">
                ...
                <div class="parallax-mouse">
                    <div id="scenePrl">
                        <div data-depth="0.25" class="prl-bg layer-right-character">
                            <i style="background-image: url('{{ BASE_URL }}images/nf_layer_86.webp');"></i>
                        </div>
                        <div data-depth="-0.2" class="prl-bg layer-muscles-beer">
                            <i style="background-image: url('{{ BASE_URL }}images/nf_logo_png_stroke_copy_2.webp');"></i>
                        </div>
                        <div data-depth="0.2" class="prl-bg layer-chef-radio">
                            <i style="background-image: url('{{ BASE_URL }}images/nf_layer_85.webp');"></i>
                        </div>
                    </div>
                </div>
                <div class="static-layer layer-center-characters">
                    <i style="background-image: url('{{ BASE_URL }}images/nf_layer_83_copy.webp');"></i>
                </div>
                <div class="static-layer layer-firework-left">
                    <i style="background-image: url('{{ BASE_URL }}images/nf_layer_81.webp');"></i>
                </div>
                <div class="static-layer layer-firework-right">
                    <i style="background-image: url('{{ BASE_URL }}images/nf_layer_81_copy_2.webp');"></i>
                </div>
                <div class="static-layer layer-firework-top-right">
                    <i style="background-image: url('{{ BASE_URL }}images/nf_layer_81_copy.webp');"></i>
                </div>
                <div class="static-layer layer-bridge-pin">
                    <i style="background-image: url('{{ BASE_URL }}images/nf_layer_83.webp');"></i>
                </div>
            </div>
            <div class="typetext" id="type-text-1" style="display: none;"></div>
            <div class="typetext" id="type-text-2" style="display: none;"></div>
        </div>
        ...
        <div class="widthCT">
            <div class="discount-box">
                ...
                <a href="{{ route('tin-tuc') }}" class="view-all" title="XEM TẤT CẢ">XEM TẤT CẢ</a>
            </div>
        </div>
        ...
        <div class="td-home__tdclub">
            ...
            <div class="pin-icn sm-right">
                <img src="{{ BASE_URL }}images/Group_7.webp" alt="">
            </div>
        </div>
    </div>
@endsection
